/**
    NOTE:
    This gist is long and untidy right now, it was created to setup the demo page.
    It allows either Camera based scanning to run or the file based scanning to run.
    
    Also, you will see mix of jQuery here, I used jQuery in demo just to easily manipulate
    UI, however it't not needed for the library to run.
    
    TODO(mebjas) simplify this demo for everyone.
